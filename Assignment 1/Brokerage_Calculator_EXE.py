from Brokerage_Calculator import calculate_brokerage
...
def driver():
    ...
    try:
        ...
        net = calculate_brokerage(buy_price, sell_price, quantity, trade_type, exchange)
        net = str(net)
        print()
        if net.find(".")!=-1:
            net = net[:net.find(".")+2]
